...
import (
	...
	"github.com/naoto67/entgql/ent/migrate"
...
func (c *TodoClient) UpdateOneID(id puuid.ID) *TodoUpdateOne {
...
func (c *TodoClient) DeleteOneID(id puuid.ID) *TodoDeleteOne {
...
func (c *TodoClient) Get(ctx context.Context, id puuid.ID) (*Todo, error) {
	return c.Query().Where(todo.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *TodoClient) GetX(ctx context.Context, id puuid.ID) *Todo {
